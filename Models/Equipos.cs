public static class Equipos{
    public static List<string> ListaEquipos {get; private set;} = new List<string> {"Boca","SanLorenzo","Temperley","Newells","ColoColo","ManCity","ManUtd","Independiente","AllBoys","Almagro"};
    ...
    public static void IngresarIndumentaria(string EquipoSeleccionado, Indumentaria item)
    {
