public static class Equipos{
    ...
    public static List<string> ListaMedias {get;private set;} = new List<string> {"azules_medias.png","blancas_medias.png","bobesponja_medias.png","celestes_medias.png","messi_medias.png","negras_medias.png","psg_medias.png","rojas_medias.png","strangerthings_medias.png","velez_medias.png"};
    public static List<string> ListaPantalones {get;private set;} = new List<string> {"amarillos_pantalon.png","azules_pantalon.png","blancos_pantalon.png","boca_pantalon.png","celestes_pantalon.png","lakers_pantalon.png","lt_pantalon.png","negro_pantalon.png","salmon_pantalon.png","sanmartin_pantalon.png"};
